<ul class="nav pull-right">
            ...
            <li>
                <ul class="dropdown-menu-list scroller" style="height:250px">
                    <li>
                        ...
                        <span class="photo"><img src="/assets/metronics/img/avatar2.jpg" alt="" /></span>
                        <span class="subject">
                    ...
                    <li>
                        <a href="inbox.html?a=view">
                        <span class="photo"><img src="/assets/metronics/img/avatar3.jpg" alt="" /></span>
                        <span class="subject">
    ...
    <li class="dropdown user">
        ...
        <ul class="dropdown-menu">
            <li><a href="/admin_users/edit"><i class="icon-user"></i> My Profile</a></li>
            ...
            <li><a href="/app/lock"><i class="icon-lock"></i> Lock Screen</a></li>
