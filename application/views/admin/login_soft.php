...
<!-- BEGIN HEAD -->
	<?php $this->load->view('commons/metronic_loginsoft_header');?>
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="login">
	<!-- BEGIN LOGO -->
	...
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="form-vertical login-form" action="/app/login_handler" method="post">
	...
	<!-- END COPYRIGHT -->
	<?php $this->load->view('commons/metronic_loginsoft_footer');?>
	<script>
